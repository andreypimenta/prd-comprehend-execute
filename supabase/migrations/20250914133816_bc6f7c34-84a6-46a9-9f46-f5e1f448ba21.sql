-- Fix user_profiles table type inconsistency and RLS policies
...
-- Update recommendations table user_id to ensure it's UUID (should already be correct)
-- Also fix RLS policies to use proper UUID comparison
