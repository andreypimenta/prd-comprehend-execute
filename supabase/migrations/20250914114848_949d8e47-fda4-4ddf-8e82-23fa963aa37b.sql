-- Continuando expansão com timing corrigido - BATCH 3 FIXED
...
('gentian_root', 'Raiz de Genciana', 'herb', 'Estimulante digestivo amargo', ARRAY['Digestão', 'Apetite', 'Enzimas'], ARRAY['má digestão', 'perda apetite'], 300, 600, 'mg', 'with_meal', 'moderate', ARRAY['Úlceras'], ARRAY[]::text[], 20, 50),
