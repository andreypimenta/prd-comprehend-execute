  ...
  return <Card className="w-full max-w-md mx-auto backdrop-blur-sm bg-card/95 shadow-card border-border/50">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-3">
          <Button variant="outline" onClick={() => handleSocialSignIn('google')} disabled={socialLoading !== null} className="w-full rounded-none text-amber-50" style={{ backgroundColor: 'hsl(218, 15%, 32%)' }}>
