    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1">
          <BioavailabilityWidget supplements={data.supplements} />
        </div>
      </div>
          ...
          <CardContent>
            <div className="space-y-4">
              {data.supplements.slice(0, 3).map((rec, index) => (
                <div key={rec.id} className="p-3 rounded-lg border bg-card hover:shadow-sm transition-shadow">
                  ...
                  <h4 className="font-semibold text-sm mb-1">{rec.supplement.name}</h4>
                  ...
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="text-muted-foreground">
                      {rec.supplement.timing === 'morning' ? 'Manhã' : 
                       rec.supplement.timing === 'evening' ? 'Noite' : 'Com refeição'}
                    </span>
                  </div>
                </div>
              ))}
